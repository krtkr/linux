 ...
 */
#ifndef _SUN8I_SCALER_H_
#define _SUN8I_SCALER_H_

#include <drm/drm_fourcc.h>
#include "sun8i_mixer.h"

#define SUN8I_SCALER_SCALE_FRAC			20
#define SUN8I_SCALER_PHASE_FRAC			20
#define SUN8I_SCALER_SIZE(w, h)			(((h) - 1) << 16 | ((w) - 1))
...
#define SUN8I_SCALER_GSU_COEFF_COUNT		16
...
#define SUN8I_SCALER_VSU_COEFF_COUNT		32

void sun8i_scaler_gsu_enable(struct sun8i_mixer *mixer, int layer, bool enable);
void sun8i_scaler_vsu_enable(struct sun8i_mixer *mixer, int layer, bool enable);
void sun8i_scaler_vsu_setup(struct sun8i_mixer *mixer, int layer,
			    u32 src_w, u32 src_h, u32 dst_w, u32 dst_h,
			    u32 hscale, u32 vscale, u32 hphase, u32 vphase,
			    const struct drm_format_info *format);
void sun8i_scaler_gsu_setup(struct sun8i_mixer *mixer, int layer,
			    u32 src_w, u32 src_h, u32 dst_w, u32 dst_h,
			    u32 hscale, u32 vscale, u32 hphase, u32 vphase);
