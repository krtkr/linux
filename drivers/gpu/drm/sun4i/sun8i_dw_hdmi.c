					   ...
					   struct drm_display_mode *adj_mode)
{
	...
	/*
	 * Since above call can change parent clock of TCON too, we have
	 * to re-set TCON clock here. Without this, changing resolution
	 * can fail with garbled image on HDMI monitor or no image at all.
	 */
